 ...
 ** 
 \*/
        ...
        var allx = Array.prototype.concat.apply([], valuesx),
            ...
            minx = (opts.xdimMin || opts.xdimMin == 0) ? opts.xdimMin : xdim.from,
            maxx = (opts.xdimMax || opts.xdimMax == 0) ? opts.xdimMax : xdim.to,
            ydim = chartinst.snapEnds(Math.min.apply(Math, ally), Math.max.apply(Math, ally), valuesy[0].length - 1),
            miny = (opts.ydimMin || opts.ydimMin == 0) ? opts.ydimMin : ydim.from,
            maxy = (opts.ydimMax || opts.ydimMax == 0) ? opts.ydimMax : ydim.to,
